...
export class SidebarComponent implements OnInit{
    ...
    private userLoggin:any=null;

    constructor( private router: Router, private globalValue:GlobalValue) {
    ...
    ngOnInit() {
        /**
         * Se procede a pasar la informacion
         * del usuario logueado extrayendola desde el servicio
         */
        this.userLoggin=this.globalValue.userLogin;
